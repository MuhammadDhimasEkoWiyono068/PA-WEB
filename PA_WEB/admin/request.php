    ...
    <section>
        <table border="1">
            ...
            <tr>
                ...
                <td> <?=$req['waktu'] ?> </td>
                <td> <a href="deny_request.php?id=<?php echo $req['id']; ?>" style="text-decoration: none; color: black;"><strong>Deny</strong></a>
                <a href="acc_request.php?id=<?php echo $req['id']; ?>" style="text-decoration: none; color: black;"><strong>Accept</strong></a></td>
            </tr>
            <?php $i++; endforeach ?>
        </table>
    </section>
