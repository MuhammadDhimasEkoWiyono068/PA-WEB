...
<body>
    ...
    <table border="1">
        ...
        <tr>
            ...
            <td> <?=$req['waktu'] ?> </td>
            <td>  <a href="delete_request.php?id=<?php echo $req['id']; ?>" onclick="return confirm('Are you sure to delete this product?')" style="text-decoration: none; color: black;"><strong>Hapus</strong></a> </td>
        </tr>
        <?php $i++; endforeach ?>
    </table>
    </section>
