    ...
    <div class="kotak">
        <form action="" method="post" enctype="multipart/form-data">
            <!-- <table class="buy1">
                ...
                <tr>
                    <td> <br> <label for="nama_customer">Customer Name </label></td>
                    <td> <br> : </td>
                    <td> <br> 
                    <input type="hidden" name="nama_customer" value="<?php $username = $akun['username']; echo $username; ?>">
                    <input type="text" name="nama" class="harga-buy" value="<?php $username = $akun['username']; echo $username; ?>" disabled></td>
                </tr>
                <tr>
                    ...
                    <input type="email" maxlength="100" name="e_mail" class="harga-buy" value="<?php $email = $akun['email']; echo $email; ?>" disabled></td>
                </tr>
                <tr>
            ...
            <table class="tabel-buy" border="0" >
                    ...
                    <tr>
                        ...
                        <td>:</td>
                        <td class="isi-buy">
                            $ <input type="text" name="harga1" class="harga-buy" disabled value="<?php $harga = $product['harga']; echo $harga; ?>">
                    ...
                    <tr>
                        <td class="form-buy"><label for="pembayaran"> <br> Payment Method</label></td>
                        <td>:</td>
                        <td class="isi-buy">
                            <input type="radio" name="pembayaran" value="Credit" required=""> Credit &emsp;
                            <input type="radio" name="pembayaran" value="Cash" required="">Cash
                        </td>
                    </tr>
                    <tr>
                        <td class="form-buy"><label for="">Proof of payment</label></td>
                        <td>:</td>
                        <td><input type="file" class="form-buy" name="gambar" id="gambar"></td>
                    </tr>
                    <tr>
                        <td colspan="4"> <br> <hr color="white"> <br> </td>
                    </tr>
