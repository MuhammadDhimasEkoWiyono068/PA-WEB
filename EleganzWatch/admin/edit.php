...
<body>
    ...
    <form action="" method="post" enctype="multipart/form-data">
            <table class="tabel-buy">
                ...
                <tr >
                    <td class="form-buy"><label for="nama">Watch Name</label></td>
                    <td>:&nbsp;&nbsp;</td>
                    <td class="isi-buy">
                ...
                <tr>
                    <td class="form-buy"><label for="nama">Watch Type</label></td>
                    <td>:</td>
                    <td class="isi-buy">
                        <select class="input-add" name="jenis" required>
                            <option></option>
                ...
                <tr>
                    <td class="form-buy"><label for="">Watch Image</label></td>
                    <td>:</td>
                    <td class="edit-img">
